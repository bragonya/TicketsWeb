...
const Card = ({ imgURL, title }) =>(
    <React.Fragment>
        ...
        <div className="blog-body">
            ...
            <h1><a href="#">Dr. Syngkuc Kim</a></h1>
            </div>
            <div className="blog-summary">
            <p>El Dr. Syngcuk Kim es el Louis I. Grossman Profesor y Presidente del Departamento de Endodoncia de la Facultad de Medicina Dental de la Universidad de Pennsylvania. También es Decano Asociado de Asuntos Globales y Decano Asociado para Educación Dental Avanzada de la Escuela de Medicina Dental . Obtuvo su licenciatura y sus postgrados dentales de la Universidad de Columbia en Nueva York. El Dr. Kim también obtuvo su doctorado en la fisiología circulatoria en la Escuela de Medicina de la Universidad de Columbia , Departamento de Fisiología . 

            </p>
            </div>
            <div className="blog-tags">
            <ul>
                <li><a href="#">Incribirse al curso</a></li>
            </ul>
            </div>
        </div>
    ...
    <div className="blog-footer">
        ...
        <li className="comments"><a href="#"><svg className="icon-bubble"><use xlinkHref="#icon-bubble"></use></svg><span className="numero">4</span></a></li>
        <li className="shares"><a href="#"><svg className="icon-star"><use xlinkHref="#icon-star"></use></svg><span className="numero">1</span></a></li>
        </ul>
    </div>

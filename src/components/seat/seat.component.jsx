            ...
            onClick:
                ...
                (evt)=>{
                    ...
                    if(!currentUser.admin && 
                        !(currentUser.email==='ferclass1@hotmail.com' || 
                          currentUser.email==='juanarnoldoperezsosa@gmail.com' || 
                          currentUser.email==='alan220193@gmail.com' || 
                          currentUser.email==='bragonya@gmail.com' || 
                          currentUser.email==='jordy.g2012@gmail.com' || 
                          currentUser.email==='luciacorado1309@gmail.com' || 
                          currentUser.email==='ferama22@gmail.com' || 
                          currentUser.email==='lizzasolorzano@hotmail.com'||
                          currentUser.email==='manuel13580@gmail.com' ||
                          currentUser.email === 'osalternative@gmail.com')){
